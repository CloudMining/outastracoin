...
To build Outastracoin (for Linux, OSX and Windows) just follow the steps under 'perform
...
[outastracoin/gitian.sigs](https://github.com/outastracoin-project/gitian.sigs.ltc/) repository, or if that's not possible create a pull
request. 
