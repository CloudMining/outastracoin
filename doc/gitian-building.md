...
*Setup instructions for a Gitian build of Outastracoin using a Debian VM or physical system.*
...
- [Building Outastracoin](#building-outastracoin)
...
Clone the git repositories for outastracoin and Gitian and then checkout the outastracoin version that you want to build.
...
Follow the instructions in [doc/release-process.md](release-process.md) in the outastracoin repository
under 'Fetch and build inputs' to install sources which require manual intervention. Also follow
the next step: 'Seed the Gitian sources cache', which will fetch all necessary source files allowing
for Gitian to work offline.

Building Outastracoin
----------------

To build Outastracoin (for Linux, OS X and Windows) just follow the steps under 'perform
Gitian builds' in [doc/release-process.md](release-process.md) in the outastracoin repository.
...
Output from `gbuild` will look something like
    ...
    From https://github.com/outastra/outastracoin
...
For example:
```bash
URL=https://github.com/user/outastracoin.git
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/outastracoin-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/outastracoin-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/outastracoin-build.assert
```
...
[outastracoin/gitian.sigs](https://github.com/outastracoin-project/gitian.sigs.oac/) repository, or if that's not possible create a pull
request. 
