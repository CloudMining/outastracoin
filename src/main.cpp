...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0ccec61b1d4db2956f89fba9888e3c6aa7cb538eb774e9b7f204c757d0436103");
    }
...
bool InitBlockIndex() {
    ...
    loop
    {
        ...
        assert(block.hashMerkleRoot == uint256("0x58c90990e3da6cf5a4002a5898bf532ec71debdb0371f13424ba9dcb2309b646"));
        block.print();
        //=====
