...
uint256 hashGenesisBlock("0xcda0535152082fcf35791b3b34cdfa510844b1c9dd2885fe8a5c43d5074f9395");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x2689e56c35d59af3a1845f50aa529cb1c27281165535aeccf8cbe7b10ea2ce31");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1460488235;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 509144310;

        if (fTestNet)
        {
            block.nTime    = 1460490704;
            block.nNonce   = 3012984;
        }
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Outastracoin: increase each by adding 2 to bitcoin's value.
